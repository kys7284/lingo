...
<meta charset="UTF-8">
<title> 관리자 </title>
<link rel="stylesheet" href="${path}/resources/css/admin/adminNotice.css">
...
<body>
	...
	<div id="noticeDetail">
		<fieldset>
			<legend><h1>공지사항 수정/삭제</h1></legend>
			<form name="detailForm" id="detailForm" action="adminNoticeUpdate.ad" method="post">
				<table>
					...
					<tr>
						...
						<td style="width: 200px" style="text-align:center" colspan="3"> ${dto.notice_writer}</td>
					</tr>
