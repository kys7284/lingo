	...
	<div class="wrap">
		...
		<div id="container">
			...
			<div id="contents">
				...
				<!-- 상단 중앙1 시작  -->
				<div id="section1"
					style="background-image: url('${path}/resources/images/faq2.jpg');background-color: #A2CFE4; background-size: 20%; background-position: center; height:280px; background-repeat: no-repeat;">
					<br> <br>
