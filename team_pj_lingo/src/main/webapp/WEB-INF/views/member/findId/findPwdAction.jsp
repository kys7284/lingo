         ...
         <div id="section2">
            <div id="s2_inner">
               <div class="join">
				  ...
				  <!-- 조회한 비밀번호가 없거나 정보가 일치하지 않을 때 -->
				    <c:choose>
						<c:when test="${empty mem_pwd}">
						<script type="text/javascript">
			                   	alert("조회결과가 없습니다.");  
			                   	window.location="${path}/findPwd.do";
			            </script>
						</c:when>
				        <c:otherwise>
					        <table>
	                        <tr>
	                           <th colspan="4" align="center" style="width:500px; height:50px"> 
									찾으시는 비밀번호는 <span style="color : 026892"><b>${mem_pwd}</b></span>입니다.
	                        	</th>
	                        </tr>
