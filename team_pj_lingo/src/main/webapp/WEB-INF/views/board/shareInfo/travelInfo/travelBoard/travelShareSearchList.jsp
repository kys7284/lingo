									...
									<div class="search-container">
										<select name="tb_category" id="tb_category">
											...
											<option
												...
												value="여행">여행</option>
											<option
												<c:if test="${dto.tb_category == '음식'}">selected</c:if>
												value="음식">음식</option>
											<option
												<c:if test="${dto.tb_category == '숙소'}">selected</c:if>
												value="숙소">숙소</option>
											<option
												<c:if test="${dto.tb_category == '관광명소'}">selected</c:if>
												value="관광명소">관광명소</option>
											<option
												<c:if test="${dto.tb_category == '기타'}">selected</c:if>
												value="기타">기타</option>
										</select>
										...
										<table>
											...
											<c:forEach var="dto" items="${searchList}">
												...
												<tr>
													...
													<td style="border: 1px solid black; text-align: center;">
														<a
														href="${path}/travelDetailAction.tc?tb_num=${dto.tb_num}&pageNum=${paging.pageNum}"><span
															style="color: black">[${dto.tb_category}]</span>
															${dto.tb_title} <span style="color: red">[${dto.tb_comment_count}]</span></a>
													</td>
											...
											<tr>
												<td colspan="6" align="center"><input type="button"
													class="inputButton" value="글쓰기" id="btnInsert"></td>
											</tr>
