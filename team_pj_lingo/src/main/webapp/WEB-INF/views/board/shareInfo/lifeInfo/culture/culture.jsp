...
<script type="text/javascript">
	...
	$(document).ready(function() {
	    $('#findCulture').click(function() {
	        $.ajax({
	            url: '${path}/findCulture.eq',
	            type: 'GET',
	            dataType: 'html',
	            beforeSend: function() {
	                // 로딩 표시
		...
		<div id="container">
			...
			<div id="contents">
				...
				<div id="side_menu">
					...
					<ul>
						<li><a href="${path}/employment.eq"> 공공기관 이용 </a></li>
					</ul>
				</div>
				<!-- 왼쪽메뉴 끝 -->
				...
				<div id="section2">
					<div class="container">
						<div class="menu">
							<a id="findCulture">한국인의 문화</a> <a id="findCustom">한국인의 관습</a>
						</div>
									...
									<form name="loginform" action="loginAction.do" method="post">
										...
										<div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
											...
											<div class="content">
												...
												<ul>
													<li>한국인들의 성은 그 수가 적으며 김 (21%), 이 (14%), 박 (8%), 최, 정, 장, 한, 임 등으로 구성되어있다.</li> 
